...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="sidebar-content" className={cn('sidebar__content', className)} {...props} />
  )
}
...
function SidebarSeparator({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="sidebar-separator" className={cn('sidebar__separator', className)} {...props} />
  )
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<'li'>) {
  return (
    <li data-slot="sidebar-menu-item" className={cn('sidebar__menu-item', className)} {...props} />
  )
}
...
function SidebarMenuButton({ className, ...props }: React.ComponentProps<'button'>) {
  return (
    <button
      ...
      className={cn('sidebar__menu-button', className)}
      {...props}
    />
  )
}
...
function SidebarMenuAction({ className, ...props }: React.ComponentProps<'button'>) {
  return (
    <button
      ...
      className={cn('sidebar__menu-action', className)}
      {...props}
    />
  )
}
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul data-slot="sidebar-menu-sub" className={cn('sidebar__menu-sub', className)} {...props} />
  )
}
...
function SidebarMenuSubButton({ className, ...props }: React.ComponentProps<'a'>) {
  return (
    <a
      ...
      className={cn('sidebar__menu-sub-button', className)}
      {...props}
    />
  )
}
...
function SidebarTrigger({ className, ...props }: React.ComponentProps<'button'>) {
  return (
    <button data-slot="sidebar-trigger" className={cn('sidebar__trigger', className)} {...props} />
  )
}
